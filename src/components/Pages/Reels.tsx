...
const ReelsPage: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-center bg-white h-[90vh] w-full my-2">
      <div className="relative w-full sm:w-[420px] h-[90vh] sm:h-[91vh] rounded-xl overflow-hidden">
        {/* Video */}
        <video
          key={reel.id}
          ref={videoRef}
        ...
        <button
          onClick={toggleMute}
          className="absolute top-5 right-5 bg-black/40 p-2 rounded-full"
        >
          {muted ? (
        ...
        <div className="absolute right-3 bottom-24 flex flex-col items-center gap-6 text-white">
          ...
          <MoreVertical className="w-7 h-7 cursor-pointer" />
        </div>

        {/* Bottom Info */}
        <div className="absolute bottom-5 left-4 text-white w-[80%] pr-14">
          <div className="flex items-center gap-3 mb-2">
            ...
            <button className="ml-3 text-xs bg-white text-black px-3 py-1 rounded">
              Follow
            </button>
          </div>
